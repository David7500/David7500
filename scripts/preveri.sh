...
STRANI=(/ /app/train /app/bus /app/pot /app/pot/podrobno /app/map /app/ovire /app/statistika /app/statistika/bus /stik /zasebnost /o-nas /donacije /android /postaje /postajalisca)
NAPAKE=0
